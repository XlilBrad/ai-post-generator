...
// Déclarer le secret (ne pas l'utiliser ici)
 ...
 */
exports.improvePost = onCall(
  {secrets: [openaiApiKey]}, // Lier le secret à cette function
  async (request) => {
    ...
    try {
      // Initialiser OpenAI ICI, dans la fonction
      const openai = new OpenAI({
        apiKey: openaiApiKey.value(), // Utiliser .value() pour obtenir la clé
      });
